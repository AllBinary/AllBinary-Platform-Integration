...
//		int maxHeader = 100;
//		in.mark(maxHeader);
//		final StringBuffer fistLine = new StringBuffer();
//		int c;
...
//		}
                ...
                //avian does not support reset
                //System.out.println("(avian does not support inputstream reset)");
                //in.reset();
...
//		}
                ...
                //System.out.println("encoding (null for avian): " + encoding);
		BufferedReader dis;
		if (encoding == null) {
