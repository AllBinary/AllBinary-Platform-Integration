...
public class Common implements MicroEmulator, CommonInterface {
    ...
    public static boolean allowJ2SEFontSizing = false;
...
//                            midletClass = midletClassLoader.loadClass(PROTOCOL + midletClassName);
...
//            is = conn.getInputStream();
            ...
            Message.error("Exception: Unable to open jar " + jarUrl, e);
            return null;
        } finally {
...
//    }
    ...
    private MIDlet loadMidlet(Class midletClass, MIDletAccess previousMidletAccess) {
        ...
        MIDletBridge.getRecordStoreManager().initForMicroemulator(MIDletBridge.getMicroEmulator());
        try {
            MIDlet m;
...
//            URL url = null;
//            try {
//                url = new URL(PROTOCOL + jarUrl);
//            } catch (MalformedURLException ex) {
//                if (jadUrl != null) {
//                    try {
//                        url = new URL(PROTOCOL + jadUrl.substring(0, jadUrl.lastIndexOf('/') + 1) + jarUrl);
//                        // TODO check if IOUtils.getCanonicalFileURL is needed
//                        //jad.setCorrectedJarURL(url.toExternalForm());
//                        jad.setCorrectedJarURL(url.toString());
...
//                Class midletClass = midletClassLoader.loadClass(PROTOCOL + jadEntry.getClassName());
...
//        try {
//            Class implClass = getExtensionsClassLoader().loadClass(PROTOCOL + implClassName);
...
//                if (isStatic) {
//                    try {
//                        Method getinst = implClass.getMethod("instance");
//                        if (Modifier.isStatic(getinst.getModifiers())) {
//                            getinst.invoke(implClass);
//                        } else {
...
//    }
    ...
    public void notifyImplementationMIDletStart() {
        for (Iterator iterator = this.extensions.iterator(); iterator.hasNext();) {
...
//                    MIDletClassLoader.enhanceCatchBlock = true;
        ...
        this.PROTOCOL = (this.mIDletClassLoaderConfig.getDelegationType(false) != MIDletClassLoaderConfig.DELEGATION_SYSTEM) ? "avianvmresource:" : "";
        ...
        if (deviceDescriptorLocation != null) {
            try {
                ...
                System.out.println("initParams - setDevice1");
...
//                    }
                    ...
                    System.out.println("initParams - setDevice2");
...
//        //System.out.println("MIDletClassLoader: " + mcl);
...
//            try {
//                //System.out.println("mIDletClassLoaderConfig: " + mIDletClassLoaderConfig);
//                mcl.configure(mIDletClassLoaderConfig, forJad);
//            } catch (MalformedURLException e) {
//                Message.error("Error", "createMIDletClassLoader, Unable to find MIDlet classes, " + Message.getCauseMessage(e), e);
//            }
//        }
...
//    }
    ...
    private static JadProperties loadJadProperties(String urlString) throws IOException {
        System.out.println("loadJadProperties: " + urlString);
        final JadProperties properties = new JadProperties();

        try {
            final String PROTOCOL = "avianvmresource:";
        final URL url = new URL(PROTOCOL + urlString);
//        if (url.getUserInfo() == null) {
...
//        }
            ...
            Logger.error("loadJadProperties Exception", e);
...
//            try {
//                System.out.println("0midletClassOrUrl: " + midletClassOrUrl);
...
//                try {
//                    System.out.println("1midletClassOrUrl: " + midletClassOrUrl);
//                    classLoader.addClassURL(midletClassOrUrl);
//                    midletClass = classLoader.loadClass(midletClassOrUrl);
//                    System.out.println("midletClass: " + midletClass);
//                } catch (MalformedURLException e) {
//                    Message.error("Error", "initMIDlet, Unable to find MIDlet class, " + Message.getCauseMessage(e), e);
//                    return null;
//                } catch (NoClassDefFoundError e) {
//                    Message.error("Error", "initMIDlet2, Unable to find MIDlet class, " + Message.getCauseMessage(e), e);
//                    return null;
//                } catch (ClassNotFoundException e) {
//                    Message.error("Error", "initMIDlet3, Unable to find MIDlet class, " + Message.getCauseMessage(e), e);
//                    return null;
//                }
//            } else {
                try {
                    System.out.println("2midletClassOrUrl: " + this.midletClassOrUrl);
                    midletClass = instance.getClass().getClassLoader().loadClass(this.PROTOCOL + this.midletClassOrUrl);
                    System.out.println("midletClass: " + midletClass);
                } catch (ClassNotFoundException e) {
                    Message.error("Error", "initMIDlet4, Unable to find MIDlet class, " + Message.getCauseMessage(e), e);
                    return null;
                }
//            }
//        } else {
//            System.out.println("3midletClassOrUrl: was null");
//        }
