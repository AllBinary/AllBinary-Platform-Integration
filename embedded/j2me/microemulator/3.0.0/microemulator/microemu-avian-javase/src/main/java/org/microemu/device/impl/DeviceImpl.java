...
public class DeviceImpl implements Device {
	...
	private static XMLElement loadDeviceDescriptor(ClassLoader classLoader, String descriptorLocation)
		...
		if (descriptor == null) {
                    final String message = "Cannot find descriptor at: " + descriptorLocation;
                        System.out.println(message);
			throw new IOException(message);
		}
//		 else {
//                    System.out.println("loadDeviceDescriptor: " + descriptor.available());
//                }
		XMLElement doc;
		try {
                    ...
                    System.out.println("loadDeviceDescriptor:  " + message);
                    throw e;
		} finally {
                    //System.out.println("loadDeviceDescriptor: finally closing");
	...
	private static XMLElement loadXmlDocument(InputStream descriptor) throws IOException {
		XMLElement doc = new XMLElement();
                //System.out.println("loadXmlDocument: parse");
		try {
			doc.parse(descriptor, 1);
                        //System.out.println("loadXmlDocument: parsed: " + doc);
		} catch (XMLParseException ex) {
                    final String message = ex.toString();
                        System.out.println("loadXmlDocument: " + message);
			throw new IOException(message);
		}
		return doc;
	}
