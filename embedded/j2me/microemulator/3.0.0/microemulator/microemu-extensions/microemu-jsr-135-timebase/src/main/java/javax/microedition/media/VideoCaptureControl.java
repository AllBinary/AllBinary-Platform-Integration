...
import static javax.microedition.media.control.VideoControl.USE_DIRECT_VIDEO;
import org.microemu.DisplayComponent;

import org.microemu.app.ui.DisplayRepaintListener;
import org.microemu.device.impl.DeviceImpl;
import org.microemu.device.platform.DisplayGraphicsFactory;
...
public class VideoCaptureControl implements VideoControl {
	...
	private DisplayRepaintListener m_displayListener = new DisplayRepaintListener() {
		...
		public void repaintInvoked(Object repaintObject) {
			Graphics g = DisplayGraphicsFactory.getInstance(repaintObject);
