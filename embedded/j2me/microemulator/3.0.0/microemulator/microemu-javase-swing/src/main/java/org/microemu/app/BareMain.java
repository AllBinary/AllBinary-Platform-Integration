...
implements ScreenListenerInterface, ResizableListenerInterface
{
    ...
    public static void main2(final String args[], final String name, final String iconPath, final int width, final int height, final boolean fullScreen, final boolean maximized) {
        ...
        //TWB - Make it so that all classloaders have the same AllPermissions
       ...
       Policy.setPolicy(new Policy()
       {
          ...
          public PermissionCollection getPermissions(CodeSource codesource)
          {
             ...
             perms.add(new FilePermission("<<ALL FILES>>", "read, write, execute, delete"));
             perms.add(new SocketPermission("*", "accept, connect, listen, resolve"));
       ...
       */
        ...
        {
            Logger.debug("", "Full-screen mode is supported");
        }
        else
        {
            Logger.debug("", "Full-screen mode will be simulated");
        }

        final BareMain app = new BareMain(graphicsDevice);
        ...
        final Component component = ((Component) app.devicePanel.getDisplayComponent());
        //TWB - Modifications for mouse input
        ...
        //TWB
        midletHelper.setAccessControlContext(AccessController.getContext());
...
//			}
//
//			int returnVal = fileChooser.showOpenDialog(BareMain.this);
...
//			}
//			if (SwingDialogWindow.show(BareMain.this, "Enter MIDlet URL:", midletUrlPanel, true)) {
...
//			}
//			if (saveForWebChooser.showSaveDialog(BareMain.this) == JFileChooser.APPROVE_OPTION) {
...
//					if (appletChooser.showOpenDialog(BareMain.this) == JFileChooser.APPROVE_OPTION) {
...
//			if (file.exists()) {
//				int answer = JOptionPane.showConfirmDialog(BareMain.this, "Override the file:" + file + "?", "Question?",
...
//			}
//
//			if (captureFileChooser.showSaveDialog(BareMain.this) == JFileChooser.APPROVE_OPTION) {
...
//	};
	...
	private ActionListener menuRecordStoreManagerListener = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			if (recordStoreManagerDialog == null) {
				recordStoreManagerDialog = new RecordStoreManagerDialog(BareMain.this, common);
	...
	private ActionListener menuLogConsoleListener = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			if (logConsoleDialog == null) {
				logConsoleDialog = new SwingLogConsoleDialog(BareMain.this, BareMain.this.logQueueAppender);
	...
	private ActionListener menuAboutListener = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			SwingDialogWindow.show(BareMain.this, "About", new SwingAboutDialog(), false);
		}
	};
	...
	private ActionListener menuExitListener = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			Config.setWindow("main", new Rectangle(BareMain.this.getX(), BareMain.this.getY(), BareMain.this.getWidth(), BareMain.this
					.getHeight()), true);
...
//		public void actionPerformed(ActionEvent e) {
//			if (SwingDialogWindow.show(BareMain.this, "Select device...", selectDevicePanel, true)) {
//				if (selectDevicePanel.getSelectedDeviceEntry().equals(deviceEntry)) {
//					return;
//				}
//				int restartMidlet = 1;
//				if (MIDletBridge.getCurrentMIDlet() != common.getLauncher()) {
//					restartMidlet = JOptionPane.showConfirmDialog(BareMain.this,
...
//				});
//                                
//                                //TWB - remove mouse input for non emulator
//                                /*
...
//	};
	...
	private ComponentListener componentListener = new ComponentAdapter() {
		...
		public void componentResized(ComponentEvent e) {
			...
			DeviceDisplayImpl deviceDisplay = (DeviceDisplayImpl) DeviceFactory.getDevice().getDeviceDisplay();
			if (deviceDisplay.isResizable()) {
                            //System.out.println("Setting Device Size: w: " + devicePanel.getWidth() + " h: " + devicePanel.getHeight());
				...
				synchronized (statusBarListener) {
					...
					timer.schedule(new CountTimerTask(count) {
                        ...
                        //TWB - when component is resized I need to notify
...
//			}
    ...
    //TWB - this may be needed
    private final Window win = new Window(this);

    private boolean isWindows = false;
    public BareMain(GraphicsDevice graphicsDevice)
    {
        this(null, graphicsDevice);
    }

    public BareMain(DeviceEntry defaultDevice, GraphicsDevice graphicsDevice)
    {
...
//, boolean isResizable
    ...
    stringBuffer.append(" isAlwaysOnTop: ");
    stringBuffer.append(this.isAlwaysOnTop());
    stringBuffer.append(" isAlwaysOnTopSupported: ");
    stringBuffer.append(this.isAlwaysOnTopSupported());
    stringBuffer.append(" isFocused: ");
    stringBuffer.append(this.isFocused());
    stringBuffer.append(" isShowing: ");
    stringBuffer.append(this.isShowing());
	...
	protected void setDeviceSize(DeviceDisplayImpl deviceDisplay, int width, int height) {
            //System.out.println("Setting Device Size: w: " + width + " h: " + height);
