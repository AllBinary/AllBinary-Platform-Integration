			...
			if (SwingDialogWindow.show(Main.this, "Select device...", selectDevicePanel, true)) {
				...
				if (restartMidlet == 0) {
					try {
						...
						MIDlet midlet = common.initMIDlet(true);
                                                //TWB - Modifications for mouse input
                                                final Component component = ((Component) devicePanel.getDisplayComponent());
                                                component.addMouseListener((MouseListener) midlet.midletHelper);
                                                component.addMouseMotionListener((MouseMotionListener) midlet.midletHelper);
...
//					}
	...
	public static void main(String args[]) {
		...
		//app.common.initMIDlet(true);
                ...
                //TWB - Modifications for mouse input
		MIDlet midlet = app.common.initMIDlet(true);
