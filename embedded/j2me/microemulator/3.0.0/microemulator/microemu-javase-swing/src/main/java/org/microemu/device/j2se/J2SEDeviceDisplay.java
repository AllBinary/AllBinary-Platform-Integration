...
public class J2SEDeviceDisplay extends DeviceDisplayImpl 
{
	...
	public Image createImage(InputStream is) throws IOException {
        ...
        {
            return new J2SEImmutableImage(name, width, height);
        }        
...
//		}
		...
		java.awt.Image image = ImageIO.read(is); //Toolkit.getDefaultToolkit().createImage(ba.toByteArray());
