...
public class J2SEInputMethod extends InputMethodImpl {
	...
	protected boolean fireInputMethodListener(J2SEButton button, final char keyChar, final int keyCode1) {
		MIDletAccess ma = MIDletBridge.getMIDletAccess();
		if (ma == null) {
			return false;
		}
	...
	public void buttonReleased(J2SEButton button, char keyChar, int keyCode1) {
		//if (ignoreButtonRelease == button) {
                    //System.out.println("TWB - skip ignore");
			//return;
		//}
		int keyCode = keyChar;
		if (button != null && keyChar == '\0') {
