...
public class Swt2 extends Common {
...
//				}
	...
	protected Swt2(Shell shell) {
		this(shell, null);
	}

	protected Swt2(Shell shell, DeviceEntry defaultDevice) {
...
//				classLoader = Common.createExtensionsClassLoader(urls);
			...
			Device device = DeviceImpl.create(emulatorContext, classLoader, entry.getDescriptorLocation(),
					SwtDevice.class);
                        System.out.println("Swt2 - setDevice");
...
//			System.err.println(ex);
	...
	protected void updateDevice() {
		Swt2.shell.setSize(shell.computeSize(SWT.DEFAULT, SWT.DEFAULT, true));
	}
