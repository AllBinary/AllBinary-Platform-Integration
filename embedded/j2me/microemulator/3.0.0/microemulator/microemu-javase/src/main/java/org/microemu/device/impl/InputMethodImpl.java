...
public class InputMethodImpl extends InputMethod implements Runnable {
	...
	public InputMethodImpl() {
		...
		this.cancel = false;
                final String THREAD_NAME = "InputMethodThread";
		this.t = new Thread(this, THREAD_NAME);
                System.out.println(THREAD_NAME + this.t.toString());
