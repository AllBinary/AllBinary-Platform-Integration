...
//    private int []rgbDataAux;
    ...
    public Sprite(Image img, int frameWidth, int frameHeight) {
        ...
        if (img.getWidth() % frameWidth != 0 ||
            ...
            final String HEIGHT = " h: ";

            stringBuffer.append("*******Exc if not OpenGL: Image: w: ");
            stringBuffer.append(img.getWidth());
            stringBuffer.append(HEIGHT);
            stringBuffer.append(img.getHeight());
            stringBuffer.append(" frame: w: ");
