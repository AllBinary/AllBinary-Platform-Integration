...
public class GDFormInput 
    implements DownGameKeyEventListenerInterface, BaseMotionGestureEventListener, RawKeyEventListener, DownKeyEventListenerInterface //, UpGameKeyEventListenerInterface, GameKeyEventListenerInterface 
{
