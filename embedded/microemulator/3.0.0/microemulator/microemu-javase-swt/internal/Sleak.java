...
import org.eclipse.swt.internal.WidgetSpy.NonDisposedWidgetTracker;
...
public class Sleak {
    ...
    private Button enableTracking, diff, stackTrace, saveAs, save;
    private Combo diffType;
    private Text text;

    private String filterPath = "";
    private String fileName = "sleakout";
    private String selectedName;
    private boolean incrementFileNames = true;
    private boolean saveImages = true;
    private int fileCount;

    private java.util.List<ObjectWithError> oldObjects = new ArrayList<>();
    private java.util.List<ObjectWithError> objects = new ArrayList<>();

    private final NonDisposedWidgetTracker nonDisposedWidgetTracker = new NonDisposedWidgetTracker();
...
//	shell2.open();
    ...
    private java.util.List<ObjectWithError> collectNewObjects(DeviceData info,
        ...
        if (object instanceof Font) {
            ...
            for (FontData data : gc.getFont().getFontData()) {
                ...
                stringBuilder.append(data.getName()).append(" ")
                    .append(data.getHeight()).append(" ")
                    .append(style).append(lf);
            }
            gc.drawString(stringBuilder.toString(), 0, 0);
            return;
        }
