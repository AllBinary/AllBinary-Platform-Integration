 ...
 * @author User
 */
public class TiledBehavior_1_4_2 extends TiledBehavior {
    
    private static final TiledBehavior_1_4_2 instance = new TiledBehavior_1_4_2();

    /**
     * @return the instance
     */
    public static TiledBehavior_1_4_2 getInstance() {
        return TiledBehavior_1_4_2.instance;
    }
