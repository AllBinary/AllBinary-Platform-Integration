...
//                list.add(Long.valueOf(index));
//            }
//        }
//        private long id;
        
public Resource() {
//    id = ((Long) list.remove(0)).intValue();
//    System.out.println("create resource: " + this.id);
}
...
//        id = ((Long) list.remove(0)).longValue();
//        System.out.println("create resourceD: " + this.id);
}
