...
public static void error (int code, Throwable throwable, String detail) {
    ...
    System.out.println(new StringBuilder().append("Error: ").append(detail).append(code).toString());
    
    if(code == SWT.ERROR_NO_HANDLES) {
        System.out.println("Exiting from SWT.ERROR_NO_HANDLES");
        System.exit(0);
    }
