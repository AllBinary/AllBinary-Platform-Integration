	...
	static {
		...
		*/
		...
		IsWin32s = info.dwPlatformId == VER_PLATFORM_WIN32s;
                //System.out.println("IsWin32s: " + IsWin32s);
		IsWin95 = info.dwPlatformId == VER_PLATFORM_WIN32_WINDOWS;
                //System.out.println("IsWin95: " + IsWin95);
		IsWinNT = info.dwPlatformId == VER_PLATFORM_WIN32_NT;
                //System.out.println("IsWinNT: " + IsWinNT);
		IsWinCE = info.dwPlatformId == VER_PLATFORM_WIN32_CE;
                //System.out.println("IsWinCE: " + IsWinCE);
		IsSP = IsSP();
                //System.out.println("IsSP: " + IsSP);
		IsPPC = IsPPC();
                //System.out.println("IsPPC: " + IsPPC);
		IsHPC = IsWinCE && !IsPPC && !IsSP;
                //System.out.println("IsHPC: " + IsHPC);
		WIN32_MAJOR = info.dwMajorVersion;
                //System.out.println("WIN32_MAJOR: " + WIN32_MAJOR);
		WIN32_MINOR = info.dwMinorVersion;
                //System.out.println("WIN32_MINOR: " + WIN32_MINOR);
		WIN32_VERSION = VERSION (WIN32_MAJOR, WIN32_MINOR);
                //System.out.println("WIN32_VERSION: " + WIN32_VERSION);
