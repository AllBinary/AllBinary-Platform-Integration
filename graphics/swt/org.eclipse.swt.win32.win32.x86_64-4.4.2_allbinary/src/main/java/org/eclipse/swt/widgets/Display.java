...
public class Display extends Device {
	...
	*/
    ...
    static class KeyState {
        ...
        public long wParam;
        public int lastKey;
        public int lastAscii;
        public boolean lastVirtual;
        public boolean lastNull;
        public boolean lastDead;
        public KeyState next;

        public KeyState(long wParam, int lastKey, int lastAscii, boolean lastVirtual, boolean lastNull, boolean lastDead, KeyState next) {
            this.wParam = wParam;
    ...
    public final ArrayList keyStateList = new ArrayList();
    KeyState keyStates;
...
boolean filterEvent (Event event) {
	//if (filterTable != null) filterTable.sendEvent (event, Long.MAX_VALUE);
...
public int getIconDepth () {
	...
	if (result == 0) {
		...
		if (result == 0) {
			...
			} catch (NumberFormatException e) {final String message = ExceptionUtil.getInstance().getStackTrace(e); System.out.println("Exception in SWT: " + message);}
		}
	}
...
//final String UPDATE_DISPLAY_LAST = "Thread - readAndDispatch:: last: ";
//final String UPDATE_DISPLAY = "Thread - readAndDispatch::";
//final String UPDATE_DISPLAY2 = "Thread - readAndDispatch2:";
//final String UPDATE_DISPLAY3 = "Thread - readAndDispatch3:";
//final String UPDATE_DISPLAY4 = "Thread - readAndDispatch4:";
//final String UPDATE_DISPLAY5 = "Thread - readAndDispatch5:";
//final String UPDATE_DISPLAY6 = "Thread - readAndDispatchEnd:";
//final String PEEK_MESSAGE = "Thread - readAndDispatch::PeekMessage";
//final String RESULT = " result: ";
//long aLastTime = System.currentTimeMillis();
//long currentTime = 0;
...
//            System.out.println(UPDATE_DISPLAY_LAST + aLastTime);
//            System.out.println(UPDATE_DISPLAY + currentTime);
//        }
//        aLastTime = currentTime;
        
        boolean r = OS.PeekMessage (msg, 0, 0, 0, OS.PM_REMOVE);
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(new StringBuffer().append(PEEK_MESSAGE).append(currentTime).append(RESULT).append(r).toString());
//        }
//        aLastTime = currentTime;
...
//            currentTime = System.currentTimeMillis();
//            if(currentTime - aLastTime > 2000) {
//                System.out.println(UPDATE_DISPLAY2 + currentTime);
//            }
//            aLastTime = currentTime;
...
//            currentTime = System.currentTimeMillis();
//            if(currentTime - aLastTime > 2000) {
//                System.out.println(UPDATE_DISPLAY3 + currentTime);
//            }
//            aLastTime = currentTime;
...
//            currentTime = System.currentTimeMillis();
//            if(currentTime - aLastTime > 2000) {
//                System.out.println(UPDATE_DISPLAY4 + currentTime);
//            }
//            aLastTime = currentTime;
...
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAY5 + currentTime);
//        }
//        aLastTime = currentTime;

        final boolean result = isDisposed () || (runMessages && runAsyncMessages (false));
        
////        currentTime = System.currentTimeMillis();
////        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAY6 + currentTime);
////        }
//        aLastTime = currentTime;
...
//final String UPDATE_DISPLAYRD = "Thread - readAndDispatchRD::";
//final String UPDATE_DISPLAYRD2 = "Thread - readAndDispatchRD2:";
//final String UPDATE_DISPLAYRD3 = "Thread - readAndDispatchRD3:";
//final String UPDATE_DISPLAYRD4 = "Thread - readAndDispatchRD4:";
//final String UPDATE_DISPLAYRD5 = "Thread - readAndDispatchRD5:";
//final String UPDATE_DISPLAYRD6 = "Thread - readAndDispatchRD6:";
...
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAYRD + currentTime);
//        }
//        aLastTime = currentTime;
...
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAYRD2 + currentTime);
//        }
//        aLastTime = currentTime;
...
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAYRD3 + currentTime);
//        }
//        aLastTime = currentTime;
...
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAYRD4 + currentTime);
//        }
//        aLastTime = currentTime;
...
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAYRD5 + currentTime);
//        }
//        aLastTime = currentTime;
...
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAYRD6 + currentTime);
//        }
//        aLastTime = currentTime;
...
//final String UPDATE_DISPLAYDSE = "Thread - readAndDispatchDSE::";
//final String UPDATE_DISPLAYDSE2 = "Thread - readAndDispatchDSE2:";
//final String UPDATE_DISPLAYDSE3 = "Thread - readAndDispatchDSE3:";
//final String UPDATE_DISPLAYDSE4 = "Thread - readAndDispatchDSE4:";
void sendEvent(EventTable eventTable, Event event) {
    
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAYDSE + currentTime);
//        }
//        aLastTime = currentTime;
...
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAYDSE2 + currentTime);
//        }
//        aLastTime = currentTime;

	try {
		//eventTable.sendEvent (event, aLastTime);
                eventTable.sendEvent (event);
                //aLastTime = System.currentTimeMillis();
	} finally {
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAYDSE3 + currentTime);
//        }
//        aLastTime = currentTime;
...
//        currentTime = System.currentTimeMillis();
//        if(currentTime - aLastTime > 2000) {
//            System.out.println(UPDATE_DISPLAYDSE4 + currentTime);
//        }
//        aLastTime = currentTime;
...
long /*int*/ windowProc (long /*int*/ hwnd, long /*int*/ msg, long /*int*/ wParam, long /*int*/ lParam) {
	...
	*/
	if ((int)/*64*/msg == OS.WM_NCHITTEST) {
		if (hitCount++ >= 1024) {
			try {Thread.sleep (1);} catch (Throwable t) {final String message = ExceptionUtil.getInstance().getStackTrace(t); System.out.println("Exception in SWT: " + message);}
		}
	} else {
		hitCount = 0;
	}
